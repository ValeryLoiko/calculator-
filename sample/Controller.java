...
public class Controller {
    ...
    @FXML
    private Button parcent_btn;

    @FXML
    private Button delit_btn;
    ...
    void initialize() {
        ...
        delit_btn.setOnAction(event -> {
            mathAction('/');
        });
        equls_btn.setOnAction(event -> {
